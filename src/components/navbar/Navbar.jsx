...
function Navbar({ activeTab, setActiveTab }) {
    return (
        <div className="  p-4 pt-9 flex items-center justify-between">
            <div className="text-gray-400 font-medium ">
                Usuarios / <span className="text-black">{activeTab}</span>
            </div>
            <div className=' mr-96 ' >
                <div className="flex items-center border border-[#C9CED6] w-[350px] py-2 px-3 rounded bg-[#f3f4f6]">
                    <svg
